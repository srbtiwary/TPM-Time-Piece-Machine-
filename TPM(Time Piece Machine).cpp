...
void drawBorder(int x=0, int y=0){
    ...
    gotoxy((width/2)+x-20, y); cout<<"T I M E   P I E C E   M A C H I N E   P R O G R E S S";
...
int main() {
	...
	do{
		...
		cout<<endl<<endl;
		cout<<"\t\t\t\t\t======================================="<<endl;
		cout<<"\n\t\t\t\t\t           TIME  PIECE  MACHINE            "<<endl;
		cout<<"\n\t\t\t\t\t======================================="<<endl<<endl;
		
		cout<<"\n\t\t\t\t\t\t Set Time for TPM "<<endl<<endl;
		...
		while(1){
			...
			if( hour == uHour && min == uMin && sec == uSec ){
				gotoxy(10,18); cout<<"Time Piece Machine Stopped";
				gotoxy(10,20); cout<<"                          ";
//				getch();
				break;
			}
		...
		gotoxy(10,22); cout<<"Do you want to use Time Piece Machine again (y/n): ";
		op = getch();
	}while(op=='y' || op=='Y');
